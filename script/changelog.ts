...
Generates UPCOMING_CHANGELOG.md by running the kiwii changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for kiwii run (default: low)
      --quiet            Suppress kiwii command output unless it fails
