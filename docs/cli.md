...
**Cuối mỗi lượt trả lời** hiện agent, model, thời gian và tốc độ sinh chữ dạng `tok/s`. Tốc độ tính bằng token output chia cho thời gian model thực sự stream, không tính thời gian chạy tool.
