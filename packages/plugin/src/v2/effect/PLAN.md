...
- Effect plugins import `@kiwii/plugin/v2/effect`, not `@kiwii/core`.
- Public domain values use generated `@kiwii/sdk` types.
...
- Define `PluginHost` domain capabilities in `@kiwii/plugin/v2/effect`.
