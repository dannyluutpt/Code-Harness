...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@kiwii/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@kiwii/ACPDirectory") {}
