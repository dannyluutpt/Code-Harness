...
import { EventSequenceTable, EventTable } from "@kiwii/core/event/sql"
...
import { WorkspaceEvent } from "@kiwii/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        KIWII_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        KIWII_WORKSPACE_ID: config.id,
        KIWII_EXPERIMENTAL_WORKSPACES: "true",
