...
import { makeApi } from "@kiwii/protocol/api"
import { LocationMiddleware } from "@kiwii/server/location"
import { SessionLocationMiddleware } from "@kiwii/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("kiwii-root")
...
export const InstanceHttpApi = HttpApi.make("kiwii-instance")
...
export const KiwiiHttpApi = HttpApi.make("kiwii")
