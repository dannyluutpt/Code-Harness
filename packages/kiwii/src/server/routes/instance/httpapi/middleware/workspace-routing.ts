...
>()("@kiwii/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@kiwii/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.KIWII_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.KIWII_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-kiwii-directory"] || process.cwd()
}
