...
import { Usage, type LLMEvent } from "@kiwii/llm"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean kiwii changed history behind a signed
