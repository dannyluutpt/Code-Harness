...
import { llmClient } from "@kiwii/core/effect/app-node-platform"
...
import type { LLMEvent } from "@kiwii/llm"
import { LLMClient } from "@kiwii/llm/route"
import type { LLMClientService } from "@kiwii/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via kiwii's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @kiwii/llm. It
