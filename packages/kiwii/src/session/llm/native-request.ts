import type { JsonSchema, LLMRequest, ProviderMetadata } from "@kiwii/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@kiwii/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @kiwii/llm request objects from kiwii's session/AI SDK-shaped data.
  return LLM.request({
