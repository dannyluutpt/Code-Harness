...
import { buildPrompt } from "@kiwii/core/session/compaction"
import { SessionCompactionEvent } from "@kiwii/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/SessionCompaction") {}
