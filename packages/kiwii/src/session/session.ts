...
import { locationServiceMapLayer } from "@kiwii/core/location-services"
...
import { PartTable, SessionTable } from "@kiwii/core/session/sql"
...
import { NonNegativeInt, optional } from "@kiwii/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".kiwii", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/Session") {}
