...
export class Service extends Context.Service<Service, Interface>()("@kiwii/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __KIWII_PHOTON_WASM_PATH?: string }).__KIWII_PHOTON_WASM_PATH =
