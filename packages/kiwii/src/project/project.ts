...
import { ProjectDirectoryTable, ProjectTable } from "@kiwii/core/project/sql"
import { ProjectDirectories } from "@kiwii/core/project/directories"
...
import { which } from "@kiwii/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.KIWII_FAKE_VCS)
