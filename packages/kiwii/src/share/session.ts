...
export class Service extends Context.Service<Service, Interface>()("@kiwii/SessionShare") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const share = Effect.fn("SessionShare.share")(function* (sessionID: SessionID) {
      ...
      if (!conf.enterprise?.url) throw new Error("Sharing requires a self-hosted share server configured via enterprise.url")
