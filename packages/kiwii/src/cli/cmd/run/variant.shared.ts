...
//
// The saved variant persists across sessions in ~/.local/state/kiwii/model.json
...
class Service extends Context.Service<Service, VariantService>()("@kiwii/RunVariant") {}
