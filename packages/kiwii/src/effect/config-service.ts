 ...
 *   "@kiwii/ServerAuthConfig",
 *   {
 *     password: Config.string("KIWII_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("KIWII_SERVER_USERNAME").pipe(Config.withDefault("kiwii")),
 *   },
 * ) {}
 *
