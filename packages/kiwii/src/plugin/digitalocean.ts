import type { Hooks, PluginInput } from "@kiwii/plugin"
import type { Model } from "@kiwii/sdk/v2"
import { InstallationVersion } from "@kiwii/core/installation/version"
import { OauthCallbackPage } from "@kiwii/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Kiwii will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
