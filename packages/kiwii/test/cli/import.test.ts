...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://github.com/dannyluutpt/Code-Harness/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://github.com/dannyluutpt/Code-Harness/s/Jsj3hNIW")).toBeNull() // legacy format
  expect(parseShareUrl("https://github.com/dannyluutpt/Code-Harness/share/")).toBeNull()
  expect(parseShareUrl("https://github.com/dannyluutpt/Code-Harness/share/id/extra")).toBeNull()
