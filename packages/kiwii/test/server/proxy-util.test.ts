...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips kiwii-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-kiwii-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-kiwii-directory")).toBeNull()
      expect(result.get("x-kiwii-workspace")).toBeNull()
