...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips kiwii-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-kiwii-directory"]).toBeUndefined()
      expect(forwarded["x-kiwii-workspace"]).toBeUndefined()
