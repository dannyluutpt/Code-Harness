...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KIWII_CALLER", () => {
    process.env["KIWII_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KIWII_CALLER", () => {
    process.env["KIWII_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KIWII_CALLER", () => {
    process.env["KIWII_CALLER"] = "unknown"
