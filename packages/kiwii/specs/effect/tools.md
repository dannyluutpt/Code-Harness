...
Practical reference for the current tool-migration state in `packages/kiwii`.
...
Tool tests should use the existing Effect helpers in `packages/kiwii/test/lib/effect.ts`:
