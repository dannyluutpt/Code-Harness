...
import { define } from "@kiwii/plugin/v2/effect"
...
import { LocationServiceMap } from "@kiwii/core/location-services"
      ...
      Effect.flatMap(([blocked, allowed]) =>
        Effect.gen(function* () {
          ...
          yield* Effect.promise(() =>
            fs.writeFile(
              path.join(blocked.path, "kiwii.json"),
              JSON.stringify({
