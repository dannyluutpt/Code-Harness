...
import { ModelV2 } from "@kiwii/core/model"
import { SessionV2 } from "@kiwii/core/session"
import { Agent } from "@kiwii/schema/agent"
import { Location } from "@kiwii/schema/location"
import { Model } from "@kiwii/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@kiwii/schema/prompt"
import { Provider } from "@kiwii/schema/provider"
import { Project } from "@kiwii/schema/project"
import { ProjectDirectories } from "@kiwii/schema/project-directories"
import { PermissionV1 } from "@kiwii/schema/permission-v1"
import { Session } from "@kiwii/schema/session"
import { SessionInput } from "@kiwii/schema/session-input"
import { SessionMessage } from "@kiwii/schema/session-message"
import { Workspace } from "@kiwii/schema/workspace"
import { Command } from "@kiwii/schema/command"
import { Connection } from "@kiwii/schema/connection"
import { Credential } from "@kiwii/schema/credential"
import { FileSystem } from "@kiwii/schema/filesystem"
import { Integration } from "@kiwii/schema/integration"
import { LLM } from "@kiwii/schema/llm"
import { Permission } from "@kiwii/schema/permission"
import { Plugin } from "@kiwii/schema/plugin"
import { Pty } from "@kiwii/schema/pty"
import { Reference } from "@kiwii/schema/reference"
import { SessionTodo } from "@kiwii/schema/session-todo"
import { Skill } from "@kiwii/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@kiwii/schema/schema"
import { ProviderV2 } from "@kiwii/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@kiwii/core/command"),
    import("@kiwii/core/integration/connection"),
    import("@kiwii/core/credential"),
    import("@kiwii/core/filesystem"),
    import("@kiwii/core/integration"),
    import("@kiwii/core/location"),
    import("@kiwii/llm"),
    import("@kiwii/core/permission"),
    import("@kiwii/core/v1/permission"),
    import("@kiwii/core/project/copy"),
    import("@kiwii/core/pty"),
    import("@kiwii/core/project/schema"),
    import("@kiwii/core/reference"),
    import("@kiwii/core/session/input"),
    import("@kiwii/core/session/message"),
    import("@kiwii/core/session/todo"),
    import("@kiwii/core/session/prompt"),
    import("@kiwii/core/skill"),
    import("@kiwii/core/v2-schema"),
    import("@kiwii/core/schema"),
    import("@kiwii/core/workspace"),
  ])
