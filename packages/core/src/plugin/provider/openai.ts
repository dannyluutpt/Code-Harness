...
import type { IntegrationOAuthMethodRegistration } from "@kiwii/plugin/v2/effect/integration"
import { define } from "@kiwii/plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `kiwii/${InstallationVersion}` }
}
