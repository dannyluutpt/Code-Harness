...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@kiwii/llm"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/v2/ToolRegistry") {}
