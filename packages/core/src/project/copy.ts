...
import { Event } from "@kiwii/schema/project-directories"
import { ProjectCopy } from "@kiwii/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/ProjectCopy") {}
