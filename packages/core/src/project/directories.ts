...
import type { EffectDrizzleSqlite } from "@kiwii/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/ProjectDirectories") {}
