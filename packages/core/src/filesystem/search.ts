...
export class Service extends Context.Service<Service, Interface>()("@kiwii/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.KIWII_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
