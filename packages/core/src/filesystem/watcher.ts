...
import { FileSystemWatcher } from "@kiwii/schema/filesystem-watcher"
...
declare const KIWII_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof KIWII_LIBC === "undefined" ? undefined : KIWII_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.KIWII_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.KIWII_EXPERIMENTAL_FILEWATCHER)) {
