...
import { type Model } from "@kiwii/llm"
import * as AnthropicMessages from "@kiwii/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@kiwii/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@kiwii/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@kiwii/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/v2/SessionRunnerModel") {}
