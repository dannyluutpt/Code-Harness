...
import { ListAnchor } from "@kiwii/schema/session"
...
import { SessionDurable } from "@kiwii/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/v2/Session") {}
