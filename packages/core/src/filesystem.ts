...
import { Entry, FileSystem, FindInput, Match } from "@kiwii/schema/filesystem"
export { Entry, Match, Submatch } from "@kiwii/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/v2/FileSystem") {}
