...
export const Flag = {
  ...
  KIWII_DISABLE_MEMORY: truthy("KIWII_DISABLE_MEMORY"),
  KIWII_DISABLE_WEBSEARCH: truthy("KIWII_DISABLE_WEBSEARCH"),
  KIWII_DISABLE_OLLAMA: truthy("KIWII_DISABLE_OLLAMA"),
  KIWII_DISABLE_LLAMACPP: truthy("KIWII_DISABLE_LLAMACPP"),
