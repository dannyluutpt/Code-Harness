...
import type { Data, Definition, Payload } from "@kiwii/schema/event"
...
import { Durable } from "@kiwii/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@kiwii/schema/event").ID
export type { Data, Definition, Payload } from "@kiwii/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@kiwii/Event") {}
