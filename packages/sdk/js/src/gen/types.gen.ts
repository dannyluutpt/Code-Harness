...
export type Config = {
  ...
  /**
   * Command configuration, see https://github.com/dannyluutpt/Code-Harness/blob/main/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://github.com/dannyluutpt/Code-Harness/blob/main/docs/agent
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
