...
export type WslJob =
  ...
  | { kind: "install-kiwii"; distro: string; startedAt: number }
...
export type WslServersState = {
  ...
  kiwiiChecks: Record<string, WslKiwiiCheck>
...
export type WslServersPlatform = {
  ...
  installKiwii(name: string): Promise<void>
