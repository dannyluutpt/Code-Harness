...
import { Session } from "@kiwii/sdk/v2/client"
...
import { retry } from "@kiwii/core/util/retry"
...
import { useTheme, type ColorScheme } from "@kiwii/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://github.com/dannyluutpt/Code-Harness")}
      renderPanel={() =>
