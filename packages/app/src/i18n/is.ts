...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Kiwii",
  "Kiwii-glugganum var óvænt lokað",
  "Kiwii svarar ekki",
  ...
  "Uppsetning Kiwii mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "kiwii er ekki uppsett í þessari dreifingu",
  "kiwii er uppsett en ekki var hægt að keyra það",
  "Kiwii er ekki uppsett í {{distro}}",
  "Uppfærslu Kiwii lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.kiwii.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.kiwii.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.kiwiiGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.kiwiiZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.kiwiiZen.visit.prefix": "Heimsókn",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Kiwii.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í kiwii.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Kiwii miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingKiwii": "Athugar Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Athugar Kiwii í {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Uppfærir Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Uppfærir Kiwii í {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Uppfærðu Kiwii í {{distro}}.",
  "wsl.onboarding.updateKiwii": "Uppfærðu Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii er tilbúið í {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii er tilbúinn.",
  "wsl.onboarding.installKiwiiIn": "Settu upp Kiwii í {{distro}}.",
  "wsl.onboarding.installKiwii": "Settu upp Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Kiwii getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Kiwii gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Kiwii aftur.",
  ...
  "help.tabs.introduction": "Kiwii Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Kiwii ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Kiwii teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (kiwii.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Kiwii styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Kiwii inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Kiwii skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Kiwii netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Kiwii",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Kiwii lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Kiwii fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Kiwii er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Kiwii ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Kiwii.",
