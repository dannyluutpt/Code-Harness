...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Kiwii failed to load",
  "desktop.recovery.terminated": "Kiwii window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Kiwii is not responding",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.kiwiiMissing": "kiwii is not installed in this distro",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii is installed but could not run",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kiwii update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
