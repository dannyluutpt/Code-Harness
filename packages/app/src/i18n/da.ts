export const dict = {
  ...
  "dialog.provider.kiwii.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.kiwii.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.kiwiiGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.kiwiiZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.kiwiiZen.visit.prefix": "Besøg ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Kiwii.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i kiwii.json",
  ...
  "dialog.server.description": "Skift hvilken Kiwii-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingKiwii": "Tjekker Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Tjekker Kiwii i {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Opdaterer Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Opdaterer Kiwii i {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Opdater Kiwii i {{distro}}.",
  "wsl.onboarding.updateKiwii": "Opdater Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Kiwii kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Kiwii kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Kiwii igen.",
  ...
  "toast.update.description": "En ny version af Kiwii ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Kiwii-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (kiwii.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Kiwii understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Kiwii-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Kiwii",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Kiwii ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Kiwii skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Kiwiis tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Kiwii starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Kiwii.",
  ...
  "desktop.recovery.loadFailed": "Kiwii kunne ikke indlæses",
  "desktop.recovery.terminated": "Kiwii-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installKiwii": "Installationen af Kiwii mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.kiwiiMissing": "kiwii er ikke installeret i denne distribution",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii er installeret, men kunne ikke køre",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Kiwii er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Kiwii Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
