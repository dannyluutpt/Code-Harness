export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Kiwii",
  ...
  "desktop.recovery.loadFailed": "Kiwii se nepodařilo načíst",
  "desktop.recovery.terminated": "Kiwii okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Kiwii nereaguje",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.kiwiiMissing": "kiwii není v této distribuci nainstalováno",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kiwii aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.kiwii.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.kiwiiGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Návštěva ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Kiwii.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v kiwii.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Kiwii serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingKiwii": "Kontrola Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Kontrola Kiwii v {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Aktualizace Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Aktualizace Kiwii v {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Aktualizace Kiwii v {{distro}}.",
  "wsl.onboarding.updateKiwii": "Aktualizovat Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii je připraveno v {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii je připraven.",
  "wsl.onboarding.installKiwiiIn": "Nainstalujte Kiwii do {{distro}}.",
  "wsl.onboarding.installKiwii": "Instalovat Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Kiwii může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Kiwii nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Kiwii ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Kiwii",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (kiwii.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Kiwii zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Kiwii uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Kiwii",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Kiwii na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description": "Zvolte, zda bude Kiwii následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Kiwii.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Kiwii",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Kiwii.",
