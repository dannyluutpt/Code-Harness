export const dict = {
  ...
  "dialog.provider.kiwii.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.kiwii.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.kiwiiGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.kiwiiZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.kiwiiZen.visit.prefix": "Visita ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Kiwii.",
  ...
  "dialog.plugins.empty": "Plugin configurati in kiwii.json",
  ...
  "dialog.server.description": "Cambia il server Kiwii a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingKiwii": "Controllo Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Controllo Kiwii in {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Aggiornamento Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Aggiornamento Kiwii in {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Aggiorna Kiwii in {{distro}}.",
  "wsl.onboarding.updateKiwii": "Aggiorna Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii è pronto in {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii è pronto.",
  "wsl.onboarding.installKiwiiIn": "Installa Kiwii in {{distro}}.",
  "wsl.onboarding.installKiwii": "Installa Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Kiwii possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Kiwii non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired": "Riavvia Windows per completare l'installazione WSL, quindi riapri Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Kiwii ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Kiwii",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (kiwii.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Kiwii non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Kiwii all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Kiwii",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Kiwii sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Kiwii segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Kiwii.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Kiwii",
  ...
  "settings.updates.toast.latest.title": "Kiwii è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Kiwii.",
  ...
  "desktop.menu.documentation": "Documentazione di Kiwii",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Kiwii",
  "desktop.recovery.terminated": "La finestra di Kiwii si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Kiwii non risponde",
  ...
  "desktop.wsl.error.installKiwii": "Installazione di Kiwii non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.kiwiiMissing": "kiwii non è installato in questa distribuzione",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Kiwii è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
