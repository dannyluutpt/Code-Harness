export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kiwii kunde inte läsas in",
  "desktop.recovery.terminated": "Kiwii-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Kiwii svarar inte",
  ...
  "desktop.wsl.error.installKiwii": "Installationen av Kiwii misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.kiwiiMissing": "kiwii är inte installerat i den här distributionen",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii är installerat men kunde inte köras",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kiwii-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.kiwii.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.kiwii.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.kiwiiGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.kiwiiZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.kiwiiZen.visit.prefix": "Besök ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Kiwii.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i kiwii.json",
  ...
  "dialog.server.description": "Växla vilken Kiwii-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingKiwii": "Kontrollerar Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Kontrollerar Kiwii i {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Uppdaterar Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Uppdaterar Kiwii i {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Uppdatera Kiwii i {{distro}}.",
  "wsl.onboarding.updateKiwii": "Uppdatera Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii är redo i {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii är redo.",
  "wsl.onboarding.installKiwiiIn": "Installera Kiwii i {{distro}}.",
  "wsl.onboarding.installKiwii": "Installera Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Kiwii kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Kiwii kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Kiwii igen.",
  ...
  "help.tabs.introduction": "Kiwii Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Kiwii ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Kiwii-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (kiwii.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Kiwii stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Kiwii-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Kiwii",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Kiwii ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Kiwii följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Kiwiis tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Kiwii startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Kiwii.",
