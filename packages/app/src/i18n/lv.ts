export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Kiwii izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Kiwii",
  "desktop.recovery.terminated": "Kiwii logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Kiwii neatbild",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.kiwiiMissing": "kiwii nav instalēts šajā distribūcijā",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kiwii atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.kiwii.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.kiwiiGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  "provider.connect.kiwiiZen.line2":
    "Ar vienu API atslēgu iegūsiet piekļuvi tādiem modeļiem kā Claude, GPT, Gemini, GLM un citiem.",
  "provider.connect.kiwiiZen.visit.prefix": "Apmeklējiet",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Kiwii.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti kiwii.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Kiwii servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingKiwii": "Pārbaudu Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Pārbaudu Kiwii distribūcijā {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Atjauninu Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Atjauninu Kiwii distribūcijā {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Atjauniniet Kiwii distribūcijā {{distro}}.",
  "wsl.onboarding.updateKiwii": "Atjauniniet Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii ir gatavs.",
  "wsl.onboarding.installKiwiiIn": "Instalējiet Kiwii distribūcijā {{distro}}.",
  "wsl.onboarding.installKiwii": "Instalējiet Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Kiwii var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Kiwii neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Kiwii no jauna.",
  ...
  "help.tabs.introduction": "Kiwii Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Kiwii versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Kiwii komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (kiwii.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed": 'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Kiwii vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Kiwii darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Kiwii serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Kiwii saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Kiwii izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description": "Izvēlieties, vai Kiwii sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Kiwii tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Kiwii",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Kiwii versiju.",
