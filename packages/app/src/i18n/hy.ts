export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Kiwii մենյու",
  ...
  "desktop.recovery.loadFailed": "Kiwii չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Kiwii պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Kiwii-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.kiwiiMissing": "kiwii-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kiwii թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.kiwii.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.kiwiiGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Kiwii-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Այցելություն ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Kiwii-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Kiwii-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են kiwii.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Kiwii սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingKiwii": "Ստուգում է Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Ստուգում է Kiwii-ը {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Թարմացվում է Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Թարմացվում է Kiwii-ը {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Թարմացնել Kiwii-ը {{distro}}-ում։",
  "wsl.onboarding.updateKiwii": "Թարմացնել Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.kiwiiReady": "Kiwii պատրաստ է։",
  "wsl.onboarding.installKiwiiIn": "Տեղադրեք Kiwii-ը {{distro}}-ում։",
  "wsl.onboarding.installKiwii": "Տեղադրեք Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Kiwii-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Kiwii-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Kiwii։",
  ...
  "help.tabs.introduction": "Kiwii Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kiwii-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Kiwii թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (kiwii.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Kiwii-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Kiwii ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Kiwii սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Kiwii",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Kiwii տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Kiwii-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Kiwii-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Kiwii-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Kiwii-ի վերջին տարբերակը։",
