export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Kiwii",
  ...
  "desktop.menu.ariaLabel": "Menú de Kiwii",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Kiwii",
  "desktop.recovery.terminated": "La ventana de Kiwii se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Kiwii no responde",
  ...
  "desktop.wsl.error.installKiwii": "No se pudo instalar Kiwii",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.kiwiiMissing": "kiwii no está instalado en esta distribución",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Kiwii finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.kiwii.tagline": "Modelos optimizados y fiables",
  "dialog.provider.kiwiiGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.kiwiiZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Kiwii.",
  ...
  "dialog.plugins.empty": "Plugins configurados en kiwii.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Kiwii al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingKiwii": "Comprobando Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Comprobando Kiwii en {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Actualizando Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Actualizando Kiwii en {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Actualiza Kiwii en {{distro}}.",
  "wsl.onboarding.updateKiwii": "Actualizar Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii está listo en {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii está listo.",
  "wsl.onboarding.installKiwiiIn": "Instala Kiwii en {{distro}}.",
  "wsl.onboarding.installKiwii": "Instalar Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Kiwii pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Kiwii no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Kiwii ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Kiwii",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (kiwii.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Kiwii aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Kiwii dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Kiwii",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Kiwii en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Kiwii sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Kiwii.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Kiwii",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Kiwii.",
