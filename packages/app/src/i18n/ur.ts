export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Kiwii مینو",
  ...
  "desktop.recovery.loadFailed": "Kiwii لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Kiwii ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Kiwii جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.kiwiiMissing": "اس ڈسٹری بیوشن میں kiwii انسٹال نہیں ہے",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.kiwiiNotInstalled": "{{distro}} میں Kiwii انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Kiwii کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.kiwii.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.kiwii.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.kiwiiGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Kiwii کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Kiwii میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.kiwiiZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.kiwiiZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Kiwii میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Kiwii میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "kiwii.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Kiwii سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingKiwiiIn": "{{distro}} میں Kiwii چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingKiwii": "Kiwii کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingKiwiiIn": "{{distro}} میں Kiwii کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateKiwiiIn": "{{distro}} میں Kiwii کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateKiwii": "Kiwii کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii {{distro}} میں تیار ہے۔",
  "wsl.onboarding.kiwiiReady": "Kiwii تیار ہے۔",
  "wsl.onboarding.installKiwiiIn": "{{distro}} میں Kiwii انسٹال کریں۔",
  "wsl.onboarding.installKiwii": "Kiwii انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Kiwii WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Kiwii اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Kiwii کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Kiwii Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kiwii ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Kiwii ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (kiwii.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Kiwii ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Kiwii میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Kiwii ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Kiwii سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Kiwii کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Kiwii کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "منتخب کریں کہ آیا Kiwii سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Kiwii کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Kiwii لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Kiwii کا تازہ ترین ورژن چلا رہے ہیں۔",
