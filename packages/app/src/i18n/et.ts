export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kiwii laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Kiwii aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Kiwii ei vasta",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.kiwiiMissing": "kiwii pole sellesse distrosse installitud",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kiwii värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.kiwii.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.kiwiiGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Kiwii'is.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Külastage ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Kiwii.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis kiwii.json",
  ...
  "dialog.server.description": "Lülitage, millise Kiwii serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii kontrollimine...",
  "wsl.onboarding.checkingKiwiiIn": "Kiwii kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Kiwii värskendamine...",
  "wsl.onboarding.updatingKiwiiIn": "Kiwii värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Värskenda Kiwii jaotises {{distro}}.",
  "wsl.onboarding.updateKiwii": "Värskenda Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii on valmis {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii on valmis.",
  "wsl.onboarding.installKiwiiIn": "Installige Kiwii asukohta {{distro}}.",
  "wsl.onboarding.installKiwii": "Installige Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Kiwii saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Kiwii ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Kiwii ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Kiwii meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (kiwii.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Kiwii ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Kiwii Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Kiwii server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Kiwii kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Kiwii teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Kiwii järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Kiwii on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Kiwii käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Kiwii uusimat versiooni.",
