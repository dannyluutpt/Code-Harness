export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Kiwii",
  ...
  "desktop.recovery.loadFailed": "Kiwii gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Kiwii ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Kiwii tidak memberi respons",
  ...
  "desktop.wsl.error.installKiwii": "Pemasangan Kiwii gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.kiwiiMissing": "kiwii tidak dipasang dalam distro ini",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Kiwii selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.kiwii.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.kiwiiGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Layari",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Kiwii.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam kiwii.json",
  ...
  "dialog.server.description": "Tukar pelayan Kiwii yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingKiwii": "Sedang menyemak Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Sedang menyemak Kiwii dalam {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Sedang mengemas kini Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Sedang mengemas kini Kiwii dalam {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Kemas kini Kiwii dalam {{distro}}.",
  "wsl.onboarding.updateKiwii": "Kemas kini Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii sedia digunakan.",
  "wsl.onboarding.installKiwiiIn": "Pasang Kiwii dalam {{distro}}.",
  "wsl.onboarding.installKiwii": "Pasang Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Kiwii boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Kiwii tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Kiwii ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Kiwii",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (kiwii.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Kiwii belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Kiwii dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Kiwii",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Kiwii pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Kiwii mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Kiwii.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Kiwii dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Kiwii.",
