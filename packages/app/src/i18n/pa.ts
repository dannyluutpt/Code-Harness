export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Kiwii لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Kiwii دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Kiwii جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.kiwiiMissing": "اس ڈسٹرو وچ kiwii انسٹال نئیں اے",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.kiwiiNotInstalled": "{{distro}} وچ Kiwii انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Kiwii دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.kiwii.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.kiwii.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.kiwiiGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Kiwii دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Kiwii وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "ویکھو ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Kiwii وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Kiwii وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "kiwii.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Kiwii سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii چیک کر رئے آں...",
  "wsl.onboarding.checkingKiwiiIn": "{{distro}} چ Kiwii دی جانچ پڑتال...",
  "wsl.onboarding.updatingKiwii": "Kiwii نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingKiwiiIn": "{{distro}} وچ Kiwii نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateKiwiiIn": "{{distro}} وچ Kiwii نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateKiwii": "Kiwii اپ ڈیٹ کرو",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii {{distro}} چ تیار اے۔",
  "wsl.onboarding.kiwiiReady": "Kiwii تیار اے۔",
  "wsl.onboarding.installKiwiiIn": "{{distro}} وچ Kiwii انسٹال کرو۔",
  "wsl.onboarding.installKiwii": "Kiwii انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kiwii دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Kiwii ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Kiwii دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Kiwii Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kiwii ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Kiwii ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (kiwii.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Kiwii ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Kiwii چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Kiwii سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Kiwii لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Kiwii کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Kiwii سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Kiwii نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Kiwii لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Kiwii دا تازہ ترین ورژن چلا رئے او۔",
