export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kiwii yüklənə bilmədi",
  "desktop.recovery.terminated": "Kiwii pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Kiwii cavab vermir",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.kiwiiMissing": "Bu distribütivdə kiwii quraşdırılmayıb",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Kiwii yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.kiwii.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.kiwiiGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Kiwii tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Kiwii-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  "provider.connect.kiwiiZen.line2":
    "Tək bir API açarı ilə Claude, GPT, Gemini, GLM və daha çox modellərə giriş əldə edəcəksiniz.",
  "provider.connect.kiwiiZen.visit.prefix": "",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Kiwii-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Kiwii-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər kiwii.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Kiwii serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii yoxlanılır...",
  "wsl.onboarding.checkingKiwiiIn": "{{distro}}-də Kiwii yoxlanılır...",
  "wsl.onboarding.updatingKiwii": "Kiwii yenilənir...",
  "wsl.onboarding.updatingKiwiiIn": "{{distro}}-də Kiwii yenilənir...",
  "wsl.onboarding.updateKiwiiIn": "{{distro}}-də Kiwii-u yeniləyin.",
  "wsl.onboarding.updateKiwii": "Kiwii-u yeniləyin",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii {{distro}}-də hazırdır.",
  "wsl.onboarding.kiwiiReady": "Kiwii hazırdır.",
  "wsl.onboarding.installKiwiiIn": "Kiwii-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installKiwii": "Kiwii quraşdırın",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kiwii WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Kiwii bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Kiwii-u yenidən açın.",
  ...
  "help.tabs.introduction": "Kiwii Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kiwii-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Kiwii komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (kiwii.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed": 'MCP server "{{name}}" uğursuz oldu. Qeyd: Kiwii hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Kiwii serverini işlət.",
  ...
  "settings.general.row.language.description": "Kiwii üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Kiwii-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description": "Kiwii-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Kiwii-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Kiwii açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Kiwii-un ən son versiyasından istifadə edirsiniz.",
