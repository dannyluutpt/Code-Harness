export const dict = {
  ...
  "desktop.recovery.loadFailed": "Không tải được Kiwii",
  "desktop.recovery.terminated": "Cửa sổ Kiwii đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Kiwii không phản hồi",
  ...
  "desktop.wsl.error.installKiwii": "Không cài đặt được Kiwii",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.kiwiiMissing": "kiwii chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Kiwii nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.kiwii.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.kiwiiGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Kiwii cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Truy cập ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Kiwii.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong kiwii.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Kiwii mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingKiwii": "Đang kiểm tra Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Đang kiểm tra Kiwii trong {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Đang cập nhật Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Đang cập nhật Kiwii trong {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Cập nhật Kiwii trong {{distro}}.",
  "wsl.onboarding.updateKiwii": "Cập nhật Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii đã sẵn sàng.",
  "wsl.onboarding.installKiwiiIn": "Cài đặt Kiwii trong {{distro}}.",
  "wsl.onboarding.installKiwii": "Cài đặt Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Kiwii có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Kiwii không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "command.permissions.mode": "Đổi chế độ cấp quyền",
  "command.permissions.mode.description": "Chọn cách duyệt các yêu cầu cấp quyền của công cụ",
  "command.status.open.description": "Xem ngữ cảnh và mức sử dụng của phiên, hoặc trạng thái máy chủ",
  "command.session.browse": "Duyệt các phiên",
  "command.session.browse.description": "Đến danh sách phiên để tiếp tục một phiên",
  "command.theme.choose.description": "Mở cài đặt để chọn chủ đề",
  "permission.mode.title": "Chế độ cấp quyền",
  "permission.mode.default": "Thủ công",
  "permission.mode.default.description": "Hỏi trước khi chỉnh sửa và chạy lệnh",
  "permission.mode.acceptEdits": "Tự duyệt chỉnh sửa",
  "permission.mode.acceptEdits.description": "Tự do chỉnh sửa tệp, hỏi trước khi chạy lệnh",
  "permission.mode.plan": "Lập kế hoạch",
  "permission.mode.plan.description": "Lập kế hoạch ở chế độ chỉ đọc",
  "permission.mode.auto": "Tự động",
  "permission.mode.auto.description": "Tự duyệt chỉnh sửa và các lệnh an toàn đã biết, hỏi với phần còn lại",
  "permission.mode.bypassPermissions": "Bỏ qua quyền",
  "permission.mode.bypassPermissions.description": "Duyệt mọi thứ không bị từ chối rõ ràng",
  "toast.permissions.mode.title": "Chế độ cấp quyền: {{mode}}",
  "toast.permissions.mode.unknown":
    'Không rõ chế độ cấp quyền "{{mode}}". Hãy dùng manual, accept-edits, plan, auto hoặc bypass.',
  "toast.model.variant.unknown": 'Không rõ mức độ suy luận "{{effort}}"',
  "toast.model.variant.unsupported": "Mô hình hiện tại không hỗ trợ các mức độ suy luận.",
  "toast.model.noMatch": 'Không có mô hình nào khớp với "{{query}}"',
  "toast.model.set": "Đã chọn mô hình {{model}}",
  "toast.slash.unavailable": "/{{command}} không dùng được ở đây",
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Kiwii ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Kiwii",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (kiwii.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Kiwii chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Kiwii bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Kiwii",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Kiwii trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Kiwii tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Kiwii.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Kiwii khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Kiwii.",
