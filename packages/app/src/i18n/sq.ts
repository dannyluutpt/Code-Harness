export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Kiwii",
  ...
  "desktop.menu.ariaLabel": "Menuja Kiwii",
  ...
  "desktop.recovery.loadFailed": "Kiwii nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Kiwii u mbyll papritur",
  "desktop.recovery.unresponsive": "Kiwii nuk po përgjigjet",
  ...
  "desktop.wsl.error.installKiwii": "Instalimi i Kiwii dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.kiwiiMissing": "Kiwii nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.kiwiiCannotRun": "Kiwii është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Kiwii përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.kiwii.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.kiwiiGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Vizitoni ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Kiwii.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në kiwii.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Kiwii lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingKiwii": "Po kontrollon Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Po kontrollon Kiwii në {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Kiwii po përditësohet...",
  "wsl.onboarding.updatingKiwiiIn": "Po përditëson Kiwii në {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Përditëso Kiwii në {{distro}}.",
  "wsl.onboarding.updateKiwii": "Përditëso Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii është gati në {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii është gati.",
  "wsl.onboarding.installKiwiiIn": "Instaloni Kiwii në {{distro}}.",
  "wsl.onboarding.installKiwii": "Instaloni Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Kiwii të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Kiwii nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Kiwii ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Kiwii",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (kiwii.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Kiwii nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Kiwii brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Kiwii",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Kiwii në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description": "Zgjidhni nëse Kiwii ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Kiwii.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Kiwii",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Kiwii.",
