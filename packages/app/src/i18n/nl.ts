export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii-documentatie",
  ...
  "desktop.recovery.loadFailed": "Kiwii kan niet worden geladen",
  "desktop.recovery.terminated": "Het Kiwii-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Kiwii reageert niet",
  ...
  "desktop.wsl.error.installKiwii": "Installatie van Kiwii is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.kiwiiMissing": "kiwii is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Kiwii-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.kiwii.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.kiwiiGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Kiwii te gebruiken.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.kiwiiZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.kiwiiZen.visit.prefix": "Ga naar ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Kiwii te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Kiwii te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in kiwii.json",
  ...
  "dialog.server.description": "Wijzig met welke Kiwii-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii controleren...",
  "wsl.onboarding.checkingKiwiiIn": "Kiwii controleren in {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Kiwii bijwerken...",
  "wsl.onboarding.updatingKiwiiIn": "Kiwii bijwerken in {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Werk Kiwii bij in {{distro}}.",
  "wsl.onboarding.updateKiwii": "Kiwii bijwerken",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii is gereed in {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii is klaar.",
  "wsl.onboarding.installKiwiiIn": "Installeer Kiwii in {{distro}}.",
  "wsl.onboarding.installKiwii": "Installeer Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Kiwii een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Kiwii kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Kiwii opnieuw.",
  ...
  "help.tabs.introduction": "Kiwii Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Kiwii ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Kiwii-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (kiwii.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Kiwii ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Kiwii-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Kiwii",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Kiwii eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Kiwii het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Kiwii aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Kiwii wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Kiwii is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Kiwii.",
