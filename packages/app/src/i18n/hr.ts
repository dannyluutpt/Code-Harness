...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Kiwii se nije uspio učitati",
  "Prozor aplikacije Kiwii neočekivano je zatvoren",
  "Kiwii ne reagira",
  ...
  "Instalacija aplikacije Kiwii nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "kiwii nije instaliran u ovoj distribuciji",
  "kiwii je instaliran, ali se ne može pokrenuti",
  "Kiwii nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Kiwii je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.kiwii.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.kiwii.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.kiwiiGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Posjetiti",
  "provider.connect.kiwiiZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Kiwii.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u kiwii.json",
  ...
  "dialog.server.description": "Promijenite na koji se Kiwii poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingKiwiiIn": "Provjera Kiwii u {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Ažuriranje Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Ažuriranje Kiwii u {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Ažurirajte Kiwii u {{distro}}.",
  "wsl.onboarding.updateKiwii": "Ažurirajte Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii je spreman u {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii je spreman.",
  "wsl.onboarding.installKiwiiIn": "Instalirajte Kiwii u {{distro}}.",
  "wsl.onboarding.installKiwii": "Instalirajte Kiwii",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Kiwii može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Kiwii nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Kiwii.",
  ...
  "help.tabs.introduction": "Radna površina Kiwii sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Kiwii ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Kiwii timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (kiwii.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Kiwii još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Kiwii Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Kiwii poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Kiwii",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Kiwii izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Kiwii slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Kiwii tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Kiwii pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Kiwii.",
