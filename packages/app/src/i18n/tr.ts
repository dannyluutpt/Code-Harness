...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kiwii yüklenemedi",
  "desktop.recovery.terminated": "Kiwii penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Kiwii yanıt vermiyor",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.kiwiiMissing": "kiwii bu dağıtımda kurulu değil",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Kiwii güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.kiwii.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.kiwiiGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Kiwii tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Kiwii'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.kiwiiZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Kiwii'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Kiwii'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler kiwii.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Kiwii sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii kontrol ediliyor...",
  "wsl.onboarding.checkingKiwiiIn": "{{distro}} içinde Kiwii kontrol ediliyor...",
  "wsl.onboarding.updatingKiwii": "Kiwii güncelleniyor...",
  "wsl.onboarding.updatingKiwiiIn": "{{distro}} içinde Kiwii güncelleniyor...",
  "wsl.onboarding.updateKiwiiIn": "{{distro}} içindeki Kiwii'u güncelleyin.",
  "wsl.onboarding.updateKiwii": "Kiwii'u güncelle",
  "wsl.onboarding.kiwiiReadyIn": "{{distro}} içinde Kiwii hazır.",
  "wsl.onboarding.kiwiiReady": "Kiwii hazır.",
  "wsl.onboarding.installKiwiiIn": "Kiwii'u {{distro}} içine kurun.",
  "wsl.onboarding.installKiwii": "Kiwii'u kur",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kiwii'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Kiwii bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Kiwii'u tekrar açın.",
  ...
  "help.tabs.introduction": "Kiwii Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kiwii'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Kiwii ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (kiwii.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Kiwii henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Kiwii Masaüstü",
  ...
  "settings.desktop.wsl.description": "Kiwii sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Kiwii'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Kiwii'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Kiwii'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Kiwii'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Kiwii başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Kiwii'un en son sürümünü kullanıyorsunuz.",
