export const dict = {
  ...
  "toast.update.description":
    "Une nouvelle version d'Kiwii ({{version}}) est maintenant disponible pour installation.",
  ...
  "sidebar.gettingStarted.line1":
    "Kiwii inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
