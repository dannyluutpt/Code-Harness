export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Kiwii",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Kiwii",
  "desktop.recovery.terminated": "La fenêtre Kiwii s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Kiwii ne répond pas",
  ...
  "desktop.wsl.error.installKiwii": "Échec de l'installation d'Kiwii",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.kiwiiMissing": "kiwii n'est pas installé dans cette distribution",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Kiwii est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.kiwii.tagline": "Modèles optimisés et fiables",
  "dialog.provider.kiwiiGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Visitez ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Kiwii.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans kiwii.json",
  ...
  "dialog.server.description": "Changez le serveur Kiwii auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingKiwii": "Vérification d'Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Vérification d'Kiwii dans {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Mise à jour d'Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Mise à jour d'Kiwii dans {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Mettez à jour Kiwii dans {{distro}}.",
  "wsl.onboarding.updateKiwii": "Mettre à jour Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii est prêt dans {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii est prêt.",
  "wsl.onboarding.installKiwiiIn": "Installez Kiwii dans {{distro}}.",
  "wsl.onboarding.installKiwii": "Installer Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Kiwii puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Kiwii n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Une nouvelle version d'Kiwii ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Kiwii",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (kiwii.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Kiwii ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Kiwii inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Kiwii dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Kiwii",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Kiwii sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Kiwii suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Kiwii.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Kiwii",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Kiwii.",
