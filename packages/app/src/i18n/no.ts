...
export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Kiwii-meny",
  ...
  "desktop.recovery.loadFailed": "Kiwii kunne ikke lastes inn",
  "desktop.recovery.terminated": "Kiwii-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Kiwii svarer ikke",
  ...
  "desktop.wsl.error.installKiwii": "Installasjonen av Kiwii mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.kiwiiMissing": "kiwii er ikke installert i denne distribusjonen",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii er installert, men kunne ikke kjøres",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Kiwii er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.kiwii.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.kiwiiGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.kiwiiZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.kiwiiZen.visit.prefix": "Besøk ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Kiwii.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i kiwii.json",
  ...
  "dialog.server.description": "Bytt hvilken Kiwii-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Kiwii ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Kiwii-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (kiwii.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Kiwii ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Kiwii-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Kiwii",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Kiwii ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Kiwii skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Kiwii.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Kiwii starter",
  ...
  "settings.updates.toast.latest.title": "Kiwii er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Kiwii.",
  ...
  "wsl.onboarding.checkingKiwii": "Sjekker Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Sjekker Kiwii i {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Oppdaterer Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Oppdaterer Kiwii i {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Oppdater Kiwii i {{distro}}.",
  "wsl.onboarding.updateKiwii": "Oppdater Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii er klar i {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii er klar.",
  "wsl.onboarding.installKiwiiIn": "Installer Kiwii i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Kiwii kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Kiwii kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Kiwii på nytt.",
  ...
  "help.tabs.introduction": "Kiwii Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
