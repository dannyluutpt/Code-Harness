export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Kiwii",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Kiwii",
  "desktop.recovery.terminated": "Okno Kiwii zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Kiwii nie odpowiada",
  ...
  "desktop.wsl.error.installKiwii": "Nie udało się zainstalować Kiwii",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.kiwiiMissing": "Program kiwii nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.kiwiiCannotRun": "Program kiwii jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Kiwii została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.kiwii.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.kiwiiGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Odwiedź ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Kiwii.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku kiwii.json",
  ...
  "dialog.server.description": "Przełącz serwer Kiwii, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingKiwii": "Sprawdzanie Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Sprawdzanie Kiwii w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Aktualizowanie Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Aktualizowanie Kiwii w dystrybucji {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Zaktualizuj Kiwii w dystrybucji {{distro}}.",
  "wsl.onboarding.updateKiwii": "Zaktualizuj Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii jest gotowy.",
  "wsl.onboarding.installKiwiiIn": "Zainstaluj Kiwii w dystrybucji {{distro}}.",
  "wsl.onboarding.installKiwii": "Zainstaluj Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Kiwii będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Kiwii nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Kiwii ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Kiwii",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (kiwii.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Kiwii nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Kiwii zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Kiwii wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Kiwii",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Kiwii na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Kiwii ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Kiwii.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Kiwii",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Kiwii.",
