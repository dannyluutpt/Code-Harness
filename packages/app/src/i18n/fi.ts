export const dict = {
  ...
  "dialog.provider.kiwii.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.kiwii.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.kiwiiGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Kiwiin tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Kiwiissa.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Avaa ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Kiwiissa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Kiwiissa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään kiwii.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Kiwii-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingKiwii": "Tarkistetaan Kiwiia...",
  "wsl.onboarding.checkingKiwiiIn": "Tarkistetaan Kiwiia kohteessa {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Päivitetään Kiwiia...",
  "wsl.onboarding.updatingKiwiiIn": "Päivitetään Kiwiia kohteessa {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Päivitä Kiwii jakelussa {{distro}}.",
  "wsl.onboarding.updateKiwii": "Päivitä Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii on valmis jakelussa {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii on valmis.",
  "wsl.onboarding.installKiwiiIn": "Asenna Kiwii jakeluun {{distro}}.",
  "wsl.onboarding.installKiwii": "Asenna Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwiia ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Kiwii voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Kiwii ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Kiwii uudelleen.",
  ...
  "toast.update.description": "Kiwiin uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Kiwii-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (kiwii.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Kiwii ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Kiwii-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Kiwiin näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Kiwii näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Kiwii järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Kiwiin teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Kiwii käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Kiwiin uusinta versiota.",
  ...
  "desktop.menu.documentation": "Kiwii-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Kiwii-valikko",
  ...
  "desktop.recovery.loadFailed": "Kiwiin lataaminen epäonnistui",
  "desktop.recovery.terminated": "Kiwii-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Kiwii ei vastaa",
  ...
  "desktop.wsl.error.installKiwii": "Kiwiin asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.kiwiiMissing": "kiwiia ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwiia ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kiwiin päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Kiwii Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
