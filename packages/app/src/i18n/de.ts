...
export const dict = {
  ...
  "dialog.provider.kiwii.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.kiwii.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.kiwiiGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Kiwii zu nutzen.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Kiwii zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Kiwii zu nutzen.",
  ...
  "dialog.plugins.empty": "In kiwii.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Kiwii-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii wird geprüft…",
  "wsl.onboarding.checkingKiwiiIn": "Kiwii in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingKiwii": "Kiwii wird aktualisiert…",
  "wsl.onboarding.updatingKiwiiIn": "Kiwii in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateKiwiiIn": "Aktualisieren Sie Kiwii in {{distro}}.",
  "wsl.onboarding.updateKiwii": "Kiwii aktualisieren",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii ist in {{distro}} bereit.",
  "wsl.onboarding.kiwiiReady": "Kiwii ist bereit.",
  "wsl.onboarding.installKiwiiIn": "Installieren Sie Kiwii in {{distro}}.",
  "wsl.onboarding.installKiwii": "Kiwii installieren",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Kiwii einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Kiwii konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Kiwii erneut.",
  ...
  "toast.update.description": "Eine neue Version von Kiwii ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Kiwii-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (kiwii.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Kiwii unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Kiwii mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Kiwii enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Kiwii Desktop",
  ...
  "settings.desktop.wsl.description": "Kiwii-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Kiwii ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Kiwii auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob Kiwii dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Kiwii anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Kiwii automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Kiwii ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Kiwii wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Kiwii konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Kiwii-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Kiwii reagiert nicht",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.kiwiiMissing": "kiwii ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Kiwii-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Kiwii Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
