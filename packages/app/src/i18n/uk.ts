export const dict = {
  ...
  "desktop.menu.documentation": "Документація Kiwii",
  ...
  "desktop.menu.ariaLabel": "Меню Kiwii",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Kiwii",
  "desktop.recovery.terminated": "Роботу вікна Kiwii несподівано завершено",
  "desktop.recovery.unresponsive": "Kiwii не відповідає",
  ...
  "desktop.wsl.error.installKiwii": "Не вдалося встановити Kiwii",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.kiwiiMissing": "kiwii не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii встановлено, але його не вдалося запустити",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Kiwii завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.kiwii.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.kiwiiGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  "provider.connect.kiwiiZen.line2":
    "З одним ключем API ви отримаєте доступ до таких моделей, як Claude, GPT, Gemini, GLM та інших.",
  "provider.connect.kiwiiZen.visit.prefix": "Відвідайте ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Kiwii.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в kiwii.json",
  ...
  "dialog.server.description": "Перемкніть сервер Kiwii, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingKiwii": "Перевірка Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Перевірка Kiwii у {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Оновлення Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Оновлення Kiwii у {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Оновіть Kiwii у {{distro}}.",
  "wsl.onboarding.updateKiwii": "Оновити Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii готовий до роботи у {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii готовий до роботи.",
  "wsl.onboarding.installKiwiiIn": "Встановіть Kiwii у {{distro}}.",
  "wsl.onboarding.installKiwii": "Встановити Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Kiwii потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Kiwii не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Kiwii ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Kiwii",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (kiwii.json)",
  "error.chain.mcpFailed": 'Сервер MCP "{{name}}" не працює. Зверніть увагу, Kiwii ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Kiwii всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Kiwii",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Kiwii на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Kiwii використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Kiwii.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Kiwii",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Kiwii.",
