export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Kiwii",
  ...
  "desktop.menu.ariaLabel": "Kiwii meni",
  ...
  "desktop.recovery.loadFailed": "Kiwii se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Kiwii-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Kiwii ne reaguje",
  ...
  "desktop.wsl.error.installKiwii": "Instalacija Kiwii-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.kiwiiMissing": "kiwii nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Kiwii-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.kiwii.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.kiwiiGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Kiwii-u.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.kiwiiZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.kiwiiZen.visit.prefix": "Posjeti ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Kiwii-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Kiwii-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u kiwii.json",
  ...
  "dialog.server.description": "Promijeni na koji se Kiwii server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingKiwii": "Provjera Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Provjera Kiwii u distribuciji {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Ažuriranje Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Ažuriranje Kiwii u distribuciji {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Ažuriraj Kiwii u distribuciji {{distro}}.",
  "wsl.onboarding.updateKiwii": "Ažuriraj Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii je spreman.",
  "wsl.onboarding.installKiwiiIn": "Instaliraj Kiwii u distribuciji {{distro}}.",
  "wsl.onboarding.installKiwii": "Instaliraj Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Kiwii mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Kiwii nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Kiwii-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Kiwii timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (kiwii.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Kiwii još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Kiwii server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Kiwii-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Kiwii izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Kiwii prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Kiwii-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Kiwii pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Kiwii-a.",
