export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii Skjøl",
  ...
  "desktop.menu.ariaLabel": "Kiwii valmynd",
  ...
  "desktop.recovery.loadFailed": "Kiwii miseydnaðist at heinta",
  "desktop.recovery.terminated": "Kiwii vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Kiwii svarar ikki",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.kiwiiMissing": "kiwii er ikki sett upp í hesi distro",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii er sett upp men kundi ikki koyra",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kiwii dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.kiwii.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.kiwii.tagline": "Álítandi optimerað modell",
  "dialog.provider.kiwiiGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.kiwiiZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.kiwiiZen.visit.prefix": "Vitja ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Kiwii.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í kiwii.json",
  ...
  "dialog.server.description": "Skift hvønn Kiwii ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingKiwii": "Kanna Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Kanna Kiwii í {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Dagføring Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Dagføring Kiwii í {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Dagfør Kiwii í {{distro}}.",
  "wsl.onboarding.updateKiwii": "Dagfør Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii er klárt í {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii er klárt.",
  "wsl.onboarding.installKiwiiIn": "Set Kiwii upp í {{distro}}.",
  "wsl.onboarding.installKiwii": "Set upp Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Kiwii kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Kiwii kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Kiwii aftur.",
  ...
  "help.tabs.introduction": "Kiwii Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Kiwii ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Kiwii toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (kiwii.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Kiwii stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Kiwii Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Kiwii ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Kiwii",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Kiwii sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Kiwii fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Kiwii er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Kiwii byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Kiwii.",
