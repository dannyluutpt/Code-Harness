export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Kiwii",
  ...
  "desktop.menu.ariaLabel": "Menu do Kiwii",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Kiwii",
  "desktop.recovery.terminated": "A janela do Kiwii foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Kiwii não está respondendo",
  ...
  "desktop.wsl.error.installKiwii": "Falha na instalação do Kiwii",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.kiwiiMissing": "O kiwii não está instalado nesta distribuição",
  "desktop.wsl.error.kiwiiCannotRun": "O kiwii está instalado, mas não pôde ser executado",
  "desktop.wsl.error.kiwiiNotInstalled": "O Kiwii não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Kiwii foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.kiwii.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.kiwiiGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.kiwiiZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.kiwiiZen.visit.prefix": "Visite ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Kiwii.",
  ...
  "dialog.plugins.empty": "Plugins configurados em kiwii.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Kiwii este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingKiwii": "Verificando o Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Verificando o Kiwii em {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Atualizando o Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Atualizando o Kiwii em {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Atualize o Kiwii em {{distro}}.",
  "wsl.onboarding.updateKiwii": "Atualizar o Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "O Kiwii está pronto em {{distro}}.",
  "wsl.onboarding.kiwiiReady": "O Kiwii está pronto.",
  "wsl.onboarding.installKiwiiIn": "Instale o Kiwii em {{distro}}.",
  "wsl.onboarding.installKiwii": "Instalar o Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Kiwii possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Kiwii não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Kiwii novamente.",
  ...
  "help.tabs.introduction": "Agora, o Kiwii Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Kiwii ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Kiwii",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (kiwii.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Kiwii ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Kiwii dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Kiwii",
  ...
  "settings.general.row.appearance.description": "Personalize como o Kiwii aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Kiwii segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Kiwii é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Kiwii iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Kiwii.",
