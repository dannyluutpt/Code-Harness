export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kiwii gagal dimuat",
  "desktop.recovery.terminated": "Jendela Kiwii berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Kiwii tidak merespons",
  ...
  "desktop.wsl.error.installKiwii": "Instalasi Kiwii gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.kiwiiMissing": "kiwii belum terinstal di distro ini",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Kiwii selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.kiwii.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.kiwiiGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Kiwii.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di kiwii.json",
  ...
  "dialog.server.description": "Ganti server Kiwii mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingKiwii": "Memeriksa Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Memeriksa Kiwii di {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Memperbarui Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Memperbarui Kiwii di {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Perbarui Kiwii di {{distro}}.",
  "wsl.onboarding.updateKiwii": "Perbarui Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii siap di {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii siap.",
  "wsl.onboarding.installKiwiiIn": "Instal Kiwii di {{distro}}.",
  "wsl.onboarding.installKiwii": "Instal Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Kiwii dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Kiwii tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Kiwii ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Kiwii",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (kiwii.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Kiwii belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Kiwii di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Kiwii",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Kiwii di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Kiwii mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Kiwii diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Kiwii.",
