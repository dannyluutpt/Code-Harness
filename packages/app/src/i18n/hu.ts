...
const desktop = [
  ...
  "Kilépés",
  "Az Kiwii betöltése sikertelen",
  "Az Kiwii ablaka váratlanul leállt",
  "Az Kiwii nem válaszol",
  ...
  "Az Kiwii telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az kiwii nincs telepítve ebben a disztribúcióban",
  "Az kiwii telepítve van, de nem futtatható",
  "Az Kiwii nincs telepítve ebben: {{distro}}",
  "Az Kiwii frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.kiwii.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.kiwii.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.kiwiiGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A Kiwii ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Kiwii-ben.",
  ...
  "provider.connect.kiwiiZen.line1":
    "A Kiwii Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Látogatás",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Kiwii-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Kiwii-ben.",
  ...
  "dialog.plugins.empty": "Az kiwii.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Kiwii szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii ellenőrzése...",
  "wsl.onboarding.checkingKiwiiIn": "Kiwii ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingKiwii": "Kiwii frissítése...",
  "wsl.onboarding.updatingKiwiiIn": "Kiwii frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateKiwiiIn": "Frissítse a Kiwii-t a {{distro}}-ben.",
  "wsl.onboarding.updateKiwii": "Frissítse a Kiwii-t",
  "wsl.onboarding.kiwiiReadyIn": "A Kiwii készen áll a {{distro}}-ben.",
  "wsl.onboarding.kiwiiReady": "A Kiwii készen áll.",
  "wsl.onboarding.installKiwiiIn": "Telepítse a Kiwii-t a {{distro}}-be.",
  "wsl.onboarding.installKiwii": "Telepítse a Kiwii-t",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "A Kiwii nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Kiwii hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Kiwii nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Kiwii programot.",
  ...
  "help.tabs.introduction": "A Kiwii Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Kiwii ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Kiwii csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (kiwii.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Kiwii még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Kiwii ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Kiwii asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Kiwii szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Kiwii kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Kiwii az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Kiwii a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Kiwii témáját.",
  ...
  "settings.updates.row.startup.description": "A Kiwii indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Kiwii legújabb verzióját futtatja.",
