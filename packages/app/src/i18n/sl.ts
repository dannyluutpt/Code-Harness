export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Kiwii ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Kiwii se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Kiwii se ne odziva",
  ...
  "desktop.wsl.error.installKiwii": "Namestitev Kiwii ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.kiwiiMissing": "kiwii ni nameščen v tej distribuciji",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Kiwii je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.kiwii.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.kiwiiGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Obisk ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Kiwii.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v kiwii.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Kiwii se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingKiwii": "Preverjanje Kiwii ...",
  "wsl.onboarding.checkingKiwiiIn": "Preverjanje Kiwii v {{distro}} ...",
  "wsl.onboarding.updatingKiwii": "Posodabljanje Kiwii ...",
  "wsl.onboarding.updatingKiwiiIn": "Posodabljanje Kiwii v {{distro}} ...",
  "wsl.onboarding.updateKiwiiIn": "Posodobite Kiwii v {{distro}}.",
  "wsl.onboarding.updateKiwii": "Posodobite Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii je pripravljen v {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii je pripravljen.",
  "wsl.onboarding.installKiwiiIn": "Namestite Kiwii v {{distro}}.",
  "wsl.onboarding.installKiwii": "Namestite Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Kiwii doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Kiwii ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Kiwii ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Kiwii",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (kiwii.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Kiwii še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Kiwii znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Kiwii",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Kiwii izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Kiwii sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Kiwii.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Kiwii",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Kiwii.",
