export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Kiwii ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง Kiwii หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "Kiwii ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installKiwii": "การติดตั้ง Kiwii ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.kiwiiMissing": "ไม่ได้ติดตั้ง kiwii ในดิสโทรนี้",
  "desktop.wsl.error.kiwiiCannotRun": "ติดตั้ง kiwii แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.kiwiiNotInstalled": "ไม่ได้ติดตั้ง Kiwii ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต Kiwii เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.kiwii.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.kiwii.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.kiwiiGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Kiwii",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kiwii",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kiwii",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน kiwii.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Kiwii ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingKiwii": "กำลังตรวจสอบ Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "กำลังตรวจสอบ Kiwii ใน {{distro}}...",
  "wsl.onboarding.updatingKiwii": "กำลังอัปเดต Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "กำลังอัปเดต Kiwii ใน {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "อัปเดต Kiwii ใน {{distro}}",
  "wsl.onboarding.updateKiwii": "อัปเดต Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.kiwiiReady": "Kiwii พร้อมใช้งานแล้ว",
  "wsl.onboarding.installKiwiiIn": "ติดตั้ง Kiwii ใน {{distro}}",
  "wsl.onboarding.installKiwii": "ติดตั้ง Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "ยังไม่ได้ติดตั้ง Kiwii",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Kiwii จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Kiwii ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Kiwii อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ Kiwii Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Kiwii ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Kiwii",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (kiwii.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Kiwii ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Kiwii รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Kiwii ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Kiwii",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Kiwii บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Kiwii ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Kiwii",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Kiwii เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Kiwii เวอร์ชันล่าสุด",
