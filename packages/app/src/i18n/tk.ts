export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Kiwii menýusy",
  ...
  "desktop.recovery.loadFailed": "Kiwii ýükläp bilmedi",
  "desktop.recovery.terminated": "Kiwii penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Kiwii jogap berenok",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.kiwiiMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Kiwii täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.kiwii.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.kiwiiGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Kiwii tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Kiwii-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.kiwiiZen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.kiwiiZen.visit.prefix": "Sapar ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Kiwii-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Kiwii-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "kiwii.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Kiwii serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii barlamak ...",
  "wsl.onboarding.checkingKiwiiIn": "{{distro}} içinde Kiwii barlanýar...",
  "wsl.onboarding.updatingKiwii": "Kiwii täzelenmek ...",
  "wsl.onboarding.updatingKiwiiIn": "{{distro}}-de Kiwii täzelenmek ...",
  "wsl.onboarding.updateKiwiiIn": "Kiwii-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateKiwii": "Kiwii täzeläň",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii {{distro}}-de taýýar.",
  "wsl.onboarding.kiwiiReady": "Kiwii taýýar.",
  "wsl.onboarding.installKiwiiIn": "{{distro}}-de Kiwii guruň.",
  "wsl.onboarding.installKiwii": "Kiwii guruň",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Kiwii WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Kiwii bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Kiwii açyň.",
  ...
  "help.tabs.introduction": "Kiwii Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Kiwii ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Kiwii toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (kiwii.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Kiwii entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Kiwii serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Kiwii üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Kiwii enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description": "Kiwii ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Kiwii-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Kiwii işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Kiwii-iň iň soňky wersiýasyny işleýärsiňiz.",
