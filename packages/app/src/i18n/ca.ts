export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Kiwii.",
  ...
  "desktop.recovery.loadFailed": "Kiwii no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Kiwii s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Kiwii no respon",
  ...
  "desktop.wsl.error.installKiwii": "La instal·lació de Kiwii ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.kiwiiMissing": "kiwii no està instal·lat en aquesta distribució",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kiwii actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.kiwii.tagline": "Models optimitzats fiables",
  "dialog.provider.kiwiiGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.kiwiiZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Kiwii.",
  ...
  "dialog.plugins.empty": "Connectors configurats a kiwii.json",
  ...
  "dialog.server.description": "Canvia a quin Kiwii servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingKiwii": "S'està comprovant Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "S'està registrant Kiwii a {{distro}}...",
  "wsl.onboarding.updatingKiwii": "S'està actualitzant Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "S'està actualitzant Kiwii a {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Actualitza Kiwii a {{distro}}.",
  "wsl.onboarding.updateKiwii": "Actualització Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii està llest a {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii està llest.",
  "wsl.onboarding.installKiwiiIn": "Instal·leu Kiwii a {{distro}}.",
  "wsl.onboarding.installKiwii": "Instal·la Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Kiwii pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Kiwii no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Kiwii ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Kiwii.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (kiwii.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Kiwii encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Kiwii Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Kiwii dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Kiwii",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Kiwii al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Kiwii segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Kiwii.",
  ...
  "settings.updates.row.startup.description": "Comprova automàticament si hi ha actualitzacions quan s'iniciï Kiwii.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Kiwii.",
