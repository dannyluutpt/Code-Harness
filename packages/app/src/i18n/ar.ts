export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Kiwii",
  "desktop.recovery.terminated": "توقفت نافذة Kiwii بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Kiwii لا يستجيب",
  ...
  "desktop.wsl.error.installKiwii": "فشل تثبيت Kiwii",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.kiwiiMissing": "kiwii غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Kiwii، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.kiwii.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.kiwii.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.kiwiiGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Kiwii",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "يمنحك Kiwii Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "قم بزيارة ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Kiwii.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في kiwii.json",
  ...
  "dialog.server.description": "تبديل خادم Kiwii الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingKiwii": "جارٍ التحقق من Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "جارٍ التحقق من Kiwii في {{distro}}...",
  "wsl.onboarding.updatingKiwii": "جارٍ تحديث Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "جارٍ تحديث Kiwii في {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "حدّث Kiwii في {{distro}}.",
  "wsl.onboarding.updateKiwii": "تحديث Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii جاهز في {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii جاهز.",
  "wsl.onboarding.installKiwiiIn": "ثبّت Kiwii في {{distro}}.",
  "wsl.onboarding.installKiwii": "تثبيت Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Kiwii من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Kiwii التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Kiwii.",
  ...
  "help.tabs.introduction": "أصبح Kiwii Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Kiwii ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Kiwii",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (kiwii.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Kiwii لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Kiwii نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Kiwii داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Kiwii",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Kiwii على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Kiwii يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Kiwii.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Kiwii",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Kiwii.",
