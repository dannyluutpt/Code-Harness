export const dict = {
  ...
  "desktop.menu.documentation": "Kiwii hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Kiwii menyusi",
  ...
  "desktop.recovery.loadFailed": "Kiwii yuklanmadi",
  "desktop.recovery.terminated": "Kiwii oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Kiwii javob bermayapti",
  ...
  "desktop.wsl.error.installKiwii": "Kiwii oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.kiwiiMissing": "Kiwii ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Kiwii yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.kiwii.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.kiwiiGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Kiwii tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Kiwii’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.kiwiiZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Kiwii da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Kiwii da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "kiwii.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Kiwii serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwii tekshirilmoqda...",
  "wsl.onboarding.checkingKiwiiIn": "Kiwii {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingKiwii": "Kiwii yangilanmoqda...",
  "wsl.onboarding.updatingKiwiiIn": "Kiwii {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateKiwiiIn": "Kiwii-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateKiwii": "Kiwii-ni yangilang",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii {{distro}} da tayyor.",
  "wsl.onboarding.kiwiiReady": "Kiwii tayyor.",
  "wsl.onboarding.installKiwiiIn": "Kiwii-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installKiwii": "Kiwii-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kiwii WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Kiwii WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Kiwii-ni qayta oching.",
  ...
  "help.tabs.introduction": "Kiwii Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kiwii ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Kiwii jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (kiwii.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Kiwii hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Kiwii bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Kiwii serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Kiwii uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Kiwii qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Kiwii tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Kiwii mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Kiwii ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Kiwii oxirgi versiyasini ishga tushiryapsiz.",
