...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Kiwii įkelti nepavyko",
  "Kiwii langas netikėtai užsidarė",
  "Kiwii neatsako",
  ...
  "Kiwii įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "kiwii šiame distributyve neįdiegtas",
  "kiwii įdiegtas, bet jo paleisti nepavyko",
  "Kiwii neįdiegtas distributyve {{distro}}",
  "Kiwii naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.kiwii.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.kiwii.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.kiwiiGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Kiwii modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.kiwiiZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.kiwiiZen.visit.prefix": "Aplankykite",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Kiwii.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti kiwii.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Kiwii serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingKiwii": "Tikrinama Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Tikrinama Kiwii {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Atnaujinamas Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Atnaujinamas Kiwii {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Atnaujinkite Kiwii {{distro}}.",
  "wsl.onboarding.updateKiwii": "Atnaujinkite Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii yra paruoštas {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii yra paruoštas.",
  "wsl.onboarding.installKiwiiIn": "Įdiekite Kiwii į {{distro}}.",
  "wsl.onboarding.installKiwii": "Įdiekite Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Kiwii galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Kiwii nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Kiwii ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Kiwii komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (kiwii.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed": "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Kiwii dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Kiwii apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Kiwii darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Kiwii serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Kiwii ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Kiwii atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Kiwii seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Kiwii temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Kiwii",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Kiwii versiją.",
