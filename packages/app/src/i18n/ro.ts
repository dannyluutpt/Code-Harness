export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Kiwii",
  ...
  "desktop.menu.ariaLabel": "Meniu Kiwii",
  ...
  "desktop.recovery.loadFailed": "Kiwii nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Kiwii s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Kiwii nu răspunde",
  ...
  "desktop.wsl.error.installKiwii": "Instalarea Kiwii a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.kiwiiMissing": "kiwii nu este instalat în această distribuție",
  "desktop.wsl.error.kiwiiCannotRun": "kiwii este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.kiwiiNotInstalled": "Kiwii nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Kiwii s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.kiwii.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.kiwii.tagline": "Modele optimizate, fiabile",
  "dialog.provider.kiwiiGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Kiwii",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Kiwii.",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.kiwiiZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.kiwiiZen.visit.prefix": "Vizitează",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Kiwii.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Kiwii.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în kiwii.json",
  ...
  "dialog.server.description": "Schimbă serverul Kiwii la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingKiwii": "Se verifică Kiwii...",
  "wsl.onboarding.checkingKiwiiIn": "Se verifică Kiwii în {{distro}}...",
  "wsl.onboarding.updatingKiwii": "Se actualizează Kiwii...",
  "wsl.onboarding.updatingKiwiiIn": "Se actualizează Kiwii în {{distro}}...",
  "wsl.onboarding.updateKiwiiIn": "Actualizează Kiwii în {{distro}}.",
  "wsl.onboarding.updateKiwii": "Actualizează Kiwii",
  "wsl.onboarding.kiwiiReadyIn": "Kiwii este gata în {{distro}}.",
  "wsl.onboarding.kiwiiReady": "Kiwii este gata.",
  "wsl.onboarding.installKiwiiIn": "Instalează Kiwii în {{distro}}.",
  "wsl.onboarding.installKiwii": "Instalează Kiwii",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwii nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Kiwii să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Kiwii nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Kiwii.",
  ...
  "help.tabs.introduction": "Kiwii Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Kiwii ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Kiwii",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (kiwii.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Kiwii nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kiwii include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Kiwii în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Kiwii",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Kiwii pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Kiwii urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Kiwii.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Kiwii",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Kiwii.",
