export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kiwiiを読み込めませんでした",
  "desktop.recovery.terminated": "Kiwiiのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Kiwiiが応答していません",
  ...
  "desktop.wsl.error.installKiwii": "Kiwiiのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.kiwiiMissing": "このディストリビューションにはkiwiiがインストールされていません",
  "desktop.wsl.error.kiwiiCannotRun": "kiwiiはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.kiwiiNotInstalled": "{{distro}}にはKiwiiがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Kiwiiのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.kiwii.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.kiwii.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.kiwiiGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Kiwiiが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Kiwiiで{{provider}}モデルを使用します。",
  ...
  "provider.connect.kiwiiZen.line1":
    "Kiwii Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.kiwiiZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.kiwiiZen.visit.prefix": " ",
  "provider.connect.kiwiiZen.visit.link": "kiwii.ai/zen",
  "provider.connect.kiwiiZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してKiwiiで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Kiwiiで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "kiwii.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するKiwiiサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingKiwii": "Kiwiiを確認中...",
  "wsl.onboarding.checkingKiwiiIn": "{{distro}}内のKiwiiを確認中...",
  "wsl.onboarding.updatingKiwii": "Kiwiiを更新中...",
  "wsl.onboarding.updatingKiwiiIn": "{{distro}}内のKiwiiを更新中...",
  "wsl.onboarding.updateKiwiiIn": "{{distro}}内のKiwiiを更新してください。",
  "wsl.onboarding.updateKiwii": "Kiwiiを更新",
  "wsl.onboarding.kiwiiReadyIn": "{{distro}}内のKiwiiの準備ができました。",
  "wsl.onboarding.kiwiiReady": "Kiwiiの準備ができました。",
  "wsl.onboarding.installKiwiiIn": "{{distro}}にKiwiiをインストールしてください。",
  "wsl.onboarding.installKiwii": "Kiwiiをインストール",
  ...
  "wsl.onboarding.distroStatus.kiwiiMissing": "Kiwiiがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "KiwiiでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Kiwiiをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Kiwii Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Kiwiiの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをKiwiiチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (kiwii.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: KiwiiはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Kiwiiには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でKiwiiサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Kiwiiの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのKiwiiの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Kiwiiがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Kiwiiのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Kiwii の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Kiwii は最新バージョンです。",
