...
beforeAll(async () => {
  ...
  mock.module("@kiwii/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@kiwii/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@kiwii/ui/icon", () => ({ Icon: () => null }))
  mock.module("@kiwii/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
