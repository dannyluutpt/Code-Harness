...
import { Switch } from "@kiwii/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://github.com/dannyluutpt/Code-Harness/blob/main/docs/themes/">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_KIWII_CHANNEL !== "prod"}>
          <SettingsRowV2
