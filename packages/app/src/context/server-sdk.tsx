import type { KiwiiEvent } from "@kiwii/client/promise"
import type { Event } from "@kiwii/sdk/v2/client"
...
export type ServerEvent = Event & { current?: KiwiiEvent }
...
export function adaptServerEvent(event: KiwiiEvent): ServerEvent {
...
function currentDelta(event: KiwiiEvent | undefined): CurrentDelta | undefined {
  if (
