...
import type { Config, KiwiiClient, Project } from "@kiwii/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@kiwii/client/promise"
import type { NormalizedProviderListResponse } from "@kiwii/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
