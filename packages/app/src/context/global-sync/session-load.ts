import type { SessionApi } from "@kiwii/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { KiwiiClient } from "@kiwii/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: KiwiiClient; directory: string; limit: number }) {
  try {
