import type { KiwiiEvent, SessionMessageInfo, SessionPendingMessage } from "@kiwii/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: KiwiiEvent): V2SessionReduction | undefined => {
