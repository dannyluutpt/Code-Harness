...
const GLOBAL_STORAGE = "kiwii.global.dat"
const WINDOW_STORAGE = "kiwii.window"
const LOCAL_PREFIX = "kiwii."
...
function workspaceStorage(dir: string) {
  ...
  return `kiwii.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `kiwii.draft.${head}.${sum}.dat`
}
