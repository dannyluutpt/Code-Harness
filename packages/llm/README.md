...
Schema-first LLM core for kiwii. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@kiwii/llm"
import { OpenAI } from "@kiwii/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@kiwii/llm/providers"
