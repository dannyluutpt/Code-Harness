...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[Kiwii](https://github.com/dannyluutpt/Code-Harness)")).toBe(
    '<p><a href="https://github.com/dannyluutpt/Code-Harness" class="external-link" target="_blank" rel="noopener noreferrer">Kiwii</a></p>\n',
  )
})
