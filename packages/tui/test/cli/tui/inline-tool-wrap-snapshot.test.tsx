...
const tools: readonly ToolFixture[] = [
  ...
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/kiwii (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/kiwii/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/kiwii/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const KIWII_DB|KIWII_DB|KIWII_DEV|Global\\.Path\\.data|data =" in packages/kiwii/src (115 matches)',
  },
] as const
