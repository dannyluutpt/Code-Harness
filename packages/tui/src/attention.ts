...
import defaultSoundPath from "@kiwii/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@kiwii/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@kiwii/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@kiwii/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@kiwii/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@kiwii/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "kiwii"
const DEFAULT_PACK_ID = "kiwii.default"
