...
export const Definitions = {
  ...
  model_refresh: keybind("ctrl+r", "Re-detect local models (Ollama, llama.cpp) from model dialog"),
  ...
  agent_cycle: keybind("ctrl+alt+a", "Next agent"),
  agent_cycle_reverse: keybind("ctrl+alt+shift+a", "Previous agent"),
  permission_mode_cycle: keybind("shift+tab", "Cycle permission mode"),
  variant_cycle: keybind("ctrl+t", "Cycle effort"),
  variant_list: keybind("none", "List effort levels"),
  ...
  "prompt.autocomplete.accept": keybind("right", "Complete autocomplete item when the cursor is at the end"),
...
export const CommandMap = {
  ...
  status_view: "kiwii.status",
  debug_view: "kiwii.debug",
  ...
  model_refresh: "model.dialog.refresh",
