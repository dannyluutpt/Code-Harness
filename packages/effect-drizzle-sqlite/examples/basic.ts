...
class Database extends Context.Service<Database, DatabaseShape>()("@kiwii/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@kiwii/example/UserStore") {
