...
import type { Definition } from "@kiwii/schema/event"
...
export const KiwiiEvent = event.schema
export type KiwiiEvent = typeof KiwiiEvent.Type
export type KiwiiEventEncoded = typeof KiwiiEvent.Encoded
