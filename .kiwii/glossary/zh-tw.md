...
- PR #13942: https://github.com/dannyluutpt/Code-Harness/pull/13942

## Do Not Translate (Locale Additions)

- `Kiwii` (preserve casing in prose; keep `kiwii` only when it is part of commands, package names, paths, or code)
- `Kiwii Zen`
- `Kiwii CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `kiwii` in prose when referring to the product name; use `Kiwii`
