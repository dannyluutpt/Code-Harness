...
- PR #10018: https://github.com/dannyluutpt/Code-Harness/pull/10018
- PR #12935: https://github.com/dannyluutpt/Code-Harness/pull/12935

## Do Not Translate (Locale Additions)

- `Kiwii` (preserve casing in prose; keep `kiwii` only in commands, package names, paths, or code)
- `Kiwii CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
