...
- PR #15835: https://github.com/dannyluutpt/Code-Harness/pull/15835

## Do Not Translate (Locale Additions)

- `Kiwii` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `kiwii` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Kiwii` in prose, `kiwii` only for exact technical identifiers
...
- Avoid changing `kiwii` to `Kiwii` inside commands, URLs, package names, or code literals
