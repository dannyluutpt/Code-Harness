...
Use this folder for locale-specific translation guidance that supplements `.kiwii/agent/translator.md`.
...
- PR #12345: https://github.com/dannyluutpt/Code-Harness/pull/12345

## Do Not Translate (Locale Additions)

- `Kiwii` (preserve casing)
