...
Desktop application and browser-based app issues, including `kiwii web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core kiwii server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Kiwii Zen, Kiwii Go, and billing issues.
